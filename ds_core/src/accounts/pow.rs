...
//!
//! Dynamically probes wasm-bindgen export symbols by signature to avoid hardcoding __wbindgen_export_0,
//! which would break startup when DeepSeek updates the WASM.

use wasmtime::{AsContextMut, Engine, InstancePre, Linker, Module, Store, ValType};

// Reuse ChallengeData from client to avoid redundant definitions
...
impl PowSolver {
    pub fn new(wasm_bytes: &[u8]) -> Result<Self, PowError> {
        ...
        // allocator: prefer __wbindgen_malloc; fall back to a signature-matching __wbindgen_export_*
        ...
        // wasm_solve: prefer explicit name; fall back to probing by unique signature (i32, i32, i32, i32, i32, f64) -> ()
