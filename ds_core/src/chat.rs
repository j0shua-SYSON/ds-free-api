//! Chat module -- request routing and response stream processing
//!
//! Acquires account resources through the accounts module, routes prompts by size
//! to different request paths, and returns SSE byte streams with an account guard.
...
///
/// Holds a reference to accounts, responsible for routing prompts and returning wrapped streams.
pub struct Chat {
...
impl Chat {
    ...
    pub async fn shutdown(&self) {
        ...
        log::info!(
            ...
            "shutdown: cleaning up {} remaining session(s)", sessions.len()
        );
