//! HTTP route handlers -- thin routing layer that delegates to OpenAIAdapter / AnthropicCompat
//!
//! All business logic lives in the adapter; handlers only extract parameters and format responses.
...
/// Mask account ID: keep only the first 3 characters of the email/phone number followed by ***
