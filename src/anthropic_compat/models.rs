...
//!
//! Based on openai_adapter's ModelList, converted to Anthropic /v1/models response format.
...
/// Parse "deepseek-expert" into "DeepSeek Expert"
...
/// Convert Unix timestamp (seconds) to RFC 3339 format string (UTC)
