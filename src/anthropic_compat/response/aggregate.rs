//! Non-streaming response mapping -- maps ChatCompletionsResponse to MessagesResponse
...
/// Map OpenAI ChatCompletionsResponse directly to MessagesResponse
pub fn from_chat_completions(resp: &ChatCompletionsResponse) -> MessagesResponse {
    debug!(target: "anthropic_compat::response::aggregate", "starting non-streaming response mapping");
